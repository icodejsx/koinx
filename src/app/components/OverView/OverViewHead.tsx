...
const OverViewHead = () => {
  return (
    <div>
      <div className="self-stretch h box-border my-10  shrink-0 flex flex-row items-start justify-start  px-0 gap-[0px_32px] text-base text-gray-2 border-b-[1px] b border-day-gray-04 ">
